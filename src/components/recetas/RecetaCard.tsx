...
function RecetaCard({ receta, onClick, onToggleFavorita, faltan, onToggleLista, enLista, index = 0 }: Props) {
  ...
  const tiltOn = hoverCapable.current && !reduce
  ...
  return (
    <motion.article
      className="bg-white dark:bg-gray-900 rounded-2xl overflow-hidden cursor-pointer group shadow-sm hover:shadow-xl dark:shadow-none dark:border dark:border-gray-800 transition-shadow duration-300"
      onClick={() => onClick(id)}
